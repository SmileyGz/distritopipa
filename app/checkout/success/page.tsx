...
function CommunityFollowCard() {
  return (
    <div className="post-order-social-card">
      <div className="posc-badge">Comunidad Distrito Pipa</div>
      <p className="posc-text">
        Subimos fotos de entregas, restocks y avisos de dinámicas en Cancún:
      </p>
      <div className="posc-buttons">
        <a
          href="https://www.facebook.com/distritopipacancun/"
          target="_blank"
          rel="noopener noreferrer"
          className="posc-btn fb"
        >
